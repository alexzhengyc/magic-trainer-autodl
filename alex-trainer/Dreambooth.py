...
class Dreambooth():
    def __init__(self, **kwargs):
        ...
        self.sd_path = kwargs.get("sd_path", "/root/autodl-fs/models/Stable-diffusion/v1-5-pruned-emaonly.safetensors")
        ...
        self.vae_path = "/root/autodl-tmp/models/VAE/vae-ft-mse-840000-ema-pruned.safetensors"
