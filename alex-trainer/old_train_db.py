...
project_name = "chenweiting-512-500-DA-hassan"
...
train_repeats = 10
reg_repeats = 0
max_train_steps = 600  # @param {type:"number"}
train_batch_size = 1
...
save_model_dir = "/root/autodl-fs/webui_models/Stable-diffusion"
v2 = False 
...
config = {
    ...
    "sample_prompt_arguments": {
        ...
        "sample_every_n_steps": sample_every_n_steps if enable_sample_prompt else 999999,
...
os.chdir(repo_dir)
command = f'''accelerate launch --config_file={accelerate_config} --num_cpu_threads_per_process=1 train_db.py --sample_prompts={sample_prompt} --dataset_config={dataset_config} --config_file={config_file}'''
